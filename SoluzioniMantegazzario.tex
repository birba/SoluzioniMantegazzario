...
\ex{6.54}\centerline{ {\it Compattezza per ricoprimenti} $\Rightarrow$ {\it Compattezza sequenziale}}
...
\ex{6.55}\centerline{{\it Separabilità $\Rightarrow$ Topologia a base numerabile}}
